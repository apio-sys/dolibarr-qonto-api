		...
		<tr>
			...
			<td>
				...
				<?php
					...
					print'<option class="side_credit" value="payment_various">'.$langs->trans("payment_various").'</option>';
...
$( ".button_link_manu" ).click(function() {
	...
	//remise à zero
	$(idOfDialog).find('select[name="link_type"] option[value="no_link"]').prop('selected', true);

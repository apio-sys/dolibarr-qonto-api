...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			case 'bnp':
				$this->oauth_version = '2.0';
				$this->dialog_url = 'https://api-nav.sandbox.bddf.bnpparibas/psd2-sandbox/corporate/authorize?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
				$this->reauthenticate_dialog_url = 'https://api-nav.sandbox.bddf.bnpparibas/psd2-sandbox/corporate/authorize?redirect_uri={REDIRECT_URI}';
				$this->access_token_url = 'https://api.sandbox.bddf.bnpparibas/psd2-sandbox/corporate/token';
				break;
